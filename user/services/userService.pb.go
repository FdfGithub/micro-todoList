...
type UesrDetailResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UesrDetailResponse) Reset() {
	*x = UesrDetailResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UesrDetailResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UesrDetailResponse) ProtoMessage() {}

func (x *UesrDetailResponse) ProtoReflect() protoreflect.Message {
	mi := &file_userService_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UesrDetailResponse.ProtoReflect.Descriptor instead.
func (*UesrDetailResponse) Descriptor() ([]byte, []int) {
	return file_userService_proto_rawDescGZIP(), []int{1}
}

func (x *UesrDetailResponse) GetUserDetail() *UserModel {
	if x != nil {
		return x.UserDetail
	}
	return nil
...
func (x *UesrDetailResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_userService_proto_rawDesc = []byte{
	...
	0x22, 0x5d, 0x0a, 0x12, 0x55, 0x65, 0x73, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65,
	...
	0x65, 0x73, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x63, 0x65, 0x73, 0x2e, 0x55, 0x65, 0x73, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65,
...
var file_userService_proto_goTypes = []interface{}{
	...
	(*UesrDetailResponse)(nil), // 1: services.UesrDetailResponse
	(*UserModel)(nil),          // 2: services.UserModel
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: services.UesrDetailResponse.UserDetail:type_name -> services.UserModel
	...
	1, // 3: services.UserService.UserLogin:output_type -> services.UesrDetailResponse
	1, // 4: services.UserService.UserRegister:output_type -> services.UesrDetailResponse
...
func file_userService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_userService_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UesrDetailResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
